...
*/
class ModelGLWidget : public QObject, public GLHandler
{
    Q_OBJECT
public:
    ModelGLWidget(GLWidget *gl, CubeDoc *document);
...
public:
    ...
    /// tiles in the shape.
    static void paint(BaseGLWidget* that, CubeDoc *doc, SlvCube *scube, bool fTargets, int singleChoise, int upToStep);
