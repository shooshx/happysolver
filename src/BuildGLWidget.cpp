...
BuildGLWidget::BuildGLWidget(GLWidget *gl, CubeDoc *document)
...
bool BuildGLWidget::boxedDblClick(int choise, int x, int y)
{
...
void BuildGLWidget::scrMove(bool rigthBot, bool ctrlPressed, int x, int y)
{
...
bool BuildGLWidget::scrDblClick(int x, int y)
{
...
bool BuildGLWidget::tiledDblClick(int choise)
{
    if (choise == -1)
        return false;
